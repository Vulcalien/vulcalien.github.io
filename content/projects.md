...
### Embedded Systems
- [ToF-to-CAN](https://github.com/Vulcalien/ToF-to-CAN): firmware that
  offers a CAN interface for the *VL53L5CX* Time-of-Flight sensor, built
  on the *NuttX* operating system. This includes a low-level interface,
  a supporting library, demos and more.
- [Color-to-CAN](https://github.com/Vulcalien/Color-to-CAN): firmware
  that offers a CAN interface for the *TCS34725* color sensor.
...
- [libsimplegba](https://github.com/Vulcalien/libsimplegba): library
